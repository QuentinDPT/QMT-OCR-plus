...
public class Camera : ICamera
{
    ...
    public PostAcquisitionParameters _postAcquisitionParameters;
    ...
    public Camera(PostAcquisitionParameters postAcquisitionParameters, StartupParameters startupParameters)
    {
        _postAcquisitionParameters = postAcquisitionParameters;
        _startupParameters = startupParameters;

        if (!System.IO.File.Exists(startupParameters.FileLocation))
        {
    ...
    public void StartCapture()
    {
        ...
        _image = _loadImage(_startupParameters.FileLocation);
    ...
    private void _capturePeriodically(CancellationToken token)
    {
        while (!token.IsCancellationRequested)
        {
            ...
            Thread.Sleep(_startupParameters.AcquisitionLoopSleep);
        }
    }
